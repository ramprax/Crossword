 ...
 */
public class ClueListActivity extends FragmentActivity
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(ClueDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(ClueDetailFragment.ARG_ITEM_ID, id);
