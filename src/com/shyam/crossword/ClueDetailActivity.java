...
public class ClueDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ClueDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ClueDetailFragment.ARG_ITEM_ID));
            ClueDetailFragment fragment = new ClueDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.clue_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                //
                NavUtils.navigateUpTo(this, new Intent(this, ClueListActivity.class));
                return true;
        }
